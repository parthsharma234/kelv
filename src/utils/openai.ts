...
export const analyzeResponse = async (
  ...
  try {
    ...
    const isFocusedInterview = interviewType && interviewType !== '';
...
export const synthesizeSpeech = async (text: string): Promise<HTMLAudioElement | null> => {
  // We're using OpenAI realtime instead of text-to-speech
  console.log('Speech synthesis called but we are using OpenAI realtime instead');
  return null;
};
