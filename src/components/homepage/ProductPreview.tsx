...
const ProductPreview: React.FC = () => {
    return (
        <section className="py-24 lg:py-28 bg-gradient-to-b from-[#030305] to-[#050508] relative overflow-hidden">
            {/* Background elements */}
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                >
                    ...
                    <h2 className="text-4xl lg:text-5xl font-semibold text-white mb-5">
                ...
                <motion.div
                    ...
                    className="relative max-w-4xl xl:max-w-5xl mx-auto"
                >
                    {/* Glow effect */}
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="absolute -left-2 lg:-left-10 top-[62%] bg-[#0a0a0f]/90 backdrop-blur-md border border-white/10 rounded-xl p-4 shadow-2xl max-w-[200px] z-10"
                    >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="absolute -right-2 lg:-right-10 top-[12%] bg-[#0a0a0f]/90 backdrop-blur-md border border-white/10 rounded-xl p-4 shadow-2xl max-w-[200px] z-10"
                    >
                        <div className="flex items-center gap-2 mb-2">
