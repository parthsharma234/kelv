...
// ============================================
// HERO SECTION - Clean & Stripe-style
// ============================================
const HeroSection: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-dark-900 px-4">
      <div className="max-w-5xl mx-auto text-center py-32">
        ...
        >
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg text-base font-medium transition-colors duration-200"
          >
            Join waitlist →
          </button>
          <button
...
// ============================================
// FEATURES SECTION - Clean & Stripe-inspired
// ============================================
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section id="features" className="py-24 md:py-32 bg-dark-900">
      <div className="container mx-auto px-4">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-dark-800 rounded-xl p-8 border border-dark-700 hover:border-orange-500/50 transition-colors duration-200"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {feature.metrics.map((metric, i) => (
                    <span key={i} className="text-xs text-gray-500 bg-dark-700/50 px-3 py-1 rounded-full">
                      {metric}
                    </span>
                  ))}
                </div>
...
const CTASection: React.FC = () => {
  return (
    <section id="waitlist" className="py-24 md:py-32 bg-dark-800">
      <div className="container mx-auto px-4">
