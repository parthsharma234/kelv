...
class CVAnalysisAggregator {
  ...
  private generateRecommendations(metrics: CVMetrics, trends: any): string[] {
  ...
  private generateDetailedFeedback(metrics: CVMetrics, trends: any): CVAnalysisSummary['detailedFeedback'] {
    return {
